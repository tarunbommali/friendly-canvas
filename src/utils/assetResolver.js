 ...
 * assets are shown. Falls back to a small set of track-level
 * assets only when nothing matches the slide directly.
 *
 * @param {object} slide      — the current slide object
 * @param {string} trackName  — e.g. "Track 1 — Why Computers Exist"
 * @param {number} maxResults — hard cap on results (default 8)
 */
export function getAssetsForSlide(slide, trackName = '', maxResults = 8) {
  ...
  // Fallback: show up to 5 track-level assets when slide is generic
  if (matched.length === 0) {
    return scored
      .filter((a) => TRACK_TO_CATEGORIES[trackName]?.includes(a.cat))
      .sort((a, b) => b.score - a.score)
      .slice(0, 5)
  }
...
// ──────────────────────────────────────────────────────────────────────────
// Track → category hints (used by fallback path)
// ──────────────────────────────────────────────────────────────────────────
const TRACK_TO_CATEGORIES = {
  'Track 1 — Why Computers Exist':            ['historical_figures', 'vintage_computers', 'hardware'],
  'Track 2 — How a Computer Actually Works':  ['hardware', 'vintage_computers', 'historical_figures'],
  'Track 3 — How Software Became Possible':   ['tech_pioneers', 'logos_languages', 'vintage_computers'],
  'Track 4 — Operating Systems':              ['logos_os', 'tech_pioneers', 'vintage_computers'],
  'Track 5 — Programming':                    ['logos_languages', 'logos_frameworks', 'tech_pioneers'],
  'Track 6 — Problem Solving & DSA':          ['logos_languages', 'historical_figures', 'logos_frameworks'],
  'Track 7 — Software Engineering':           ['logos_vcs', 'tech_pioneers', 'logos_languages'],
  'Track 8 — Networking Fundamentals':        ['hardware', 'logos_cloud', 'logos_devops'],
  'Track 9 — How the Web Works':              ['logos_frameworks', 'logos_cloud', 'tech_pioneers'],
  'Track 10 — Web Development':               ['logos_frameworks', 'logos_languages', 'logos_databases'],
  'Track 11 — Frameworks & Backend':          ['logos_frameworks', 'logos_databases', 'logos_devops'],
  'Track 12 — Databases':                     ['logos_databases', 'logos_cloud', 'logos_devops'],
  'Track 13 — Security':                      ['logos_os', 'logos_devops', 'logos_vcs'],
  'Track 14 — Linux + DevOps':               ['logos_devops', 'logos_os', 'logos_vcs'],
  'Track 15 — Cloud Computing':               ['logos_cloud', 'logos_devops', 'hardware'],
  'Track 16 — System Design':                 ['logos_cloud', 'logos_devops', 'logos_databases'],
  'Track 17 — Data & Python':                 ['logos_languages', 'logos_frameworks', 'modern_engineers'],
  'Track 18 — Machine Learning':              ['logos_ai_ml', 'modern_engineers', 'logos_frameworks'],
  'Track 19 — Deep Learning':                 ['logos_ai_ml', 'modern_engineers', 'hardware'],
  'Track 20 — Generative AI':                 ['modern_engineers', 'logos_ai_ml', 'memes'],
  'Track 21 — AI Agents':                     ['logos_ai_ml', 'modern_engineers', 'logos_frameworks'],
}
